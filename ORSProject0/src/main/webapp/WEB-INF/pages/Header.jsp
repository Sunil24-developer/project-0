...
--%>
	...
	<div style="margin-right: 80px;width: 110px;" class="dropdown">
		<button class="btn btn-info" style="background-color: #3a3a46a6;; width: 100px;" type="button" data-toggle="dropdown">
			<font color="black">
				<b style="color: white"><s:message code="language.hindi"></s:message></b>
			</font> 
			<font color="white">
		...
		<ul class="dropdown-menu">
			<li><a href="<c:url value="?lang=en"></c:url>"><b style="color: black">English</b></a>
			</li>
			<li><a href="<c:url value="?lang=hi"></c:url>"><b style="color: black"><s:message code="label.hindi"></s:message></b></a>
			</li>
		</ul>
	</div>
